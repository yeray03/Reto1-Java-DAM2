...
public class Historico {
    ...
    public Historico(String workoutNombre, int nivel, Date fecha, long tiempoTotal, 
        ...
        this.porcentajeCompletado = ejerciciosTotales > 0 ? 
            (ejerciciosCompletados * 100.0 / ejerciciosTotales) : 0;
    }
    ...
    public String toString() {
        return "Historico [workoutNombre=" + workoutNombre + ", nivel=" + nivel + ", fecha=" + fecha
                + ", tiempoTotal=" + tiempoTotal + ", ejerciciosCompletados=" + ejerciciosCompletados
                + ", ejerciciosTotales=" + ejerciciosTotales + ", porcentajeCompletado=" + porcentajeCompletado + "]";
    }
}